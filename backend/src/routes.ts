...
import { outbreakProjectionRouter } from './modules/outbreak-projection/outbreak-projection.routes.js';
...
apiRouter.use('/official/outbreak-projection', outbreakProjectionRouter);
